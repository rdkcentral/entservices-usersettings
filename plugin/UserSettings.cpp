...
namespace WPEFramework
{
    ...
    UserSettings::UserSettings() : _service(nullptr), _connectionId(0), _userSetting(nullptr), _userSettingsInspector(nullptr), _usersettingsNotification(this), configure(nullptr), configure(nullptr), _backupProvider(nullptr)
    {
